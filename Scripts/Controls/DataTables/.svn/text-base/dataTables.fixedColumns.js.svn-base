 ...
 */
 	...
 	/*在IE9下修改的冻结列对齐的函数*/
 	function forIe9(){
		var wid = $(".DTFC_LeftWrapper").width();

		$(".DTFC_LeftBodyLiner").css(
			{"overflowY": "visible"}
		);
		$(".DTFC_LeftBodyLiner").width(wid);
		/*
		$(".dataTables_scrollHead th").eq(3).width(function(index, val){
			return (+val-1);
		});*/
	}
 	...
 	function forIe8(){
		...
		/*
		var i = $(".DTFC_LeftBodyLiner td").css(
			{
				"padding-Bottom": "0px"
			}
		);*/
	...
	"_fnDraw": function ( bAll )
	{
		...
		if($browser.msie){
			if($browser.version == "9.0"){
				forIe9();
				//console.log($(".DTFC_LeftBodyLiner"));
				console.log("9");
